...
INSERT INTO `tbanggota` (`idanggota`, `nama`, `jeniskelamin`, `alamat`, `status`) VALUES
	...
	('AG009', 'Rina Auliah', 'Wanita', 'Jl.Merpati No 445', 'Tidak Meminjam');
...
INSERT INTO `tbuser` (`iduser`, `nama`, `alamat`, `password`) VALUES
	('admin', 'admin', 'jakarta', '21232f297a57a5a743894a0e4a801fc3'),
	('US001', 'Andi Rahman Hakim', 'Jl.Pramuka No 9', '81dc9bdb52d04dc20036dbd8313ed055');
